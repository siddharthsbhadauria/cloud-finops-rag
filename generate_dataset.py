...
def run_pipeline():
    ...
    # 1. Dynamic API Ingestion across all providers (Google, Anthropic, OpenAI, DeepSeek, Meta, Qwen, xAI, Mistral)
    pricing_data = CloudPricingIngestor().get_all_llm_pricing(top_n=60)
